        ...
        <View style={{ paddingHorizontal: 24, marginTop: 24 }}>
          <View style={styles.menuCard}>
            <View style={styles.menuItem}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 12, color: '#9ca3af' }}>Votre email</Text>
                <Text style={styles.menuLabel}>{user?.email || 'Non disponible'}</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={{ paddingHorizontal: 24, marginTop: 24 }}>
          <View style={{
            ...
            <Text style={{ color: '#3b82f6', fontSize: 13 }}>
              Pour modifier votre adresse email, veuillez contacter notre support.
            </Text>
          </View>
        </View>
      </ScrollView>
